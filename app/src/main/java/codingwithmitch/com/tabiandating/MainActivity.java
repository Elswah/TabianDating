...
public class MainActivity extends AppCompatActivity implements IMainActivity, BottomNavigationViewEx.OnNavigationItemSelectedListener,
        ...
        switch (item.getItemId()) {
            ...
            case R.id.settings: {
                ...
                if (mSettingsFragment == null) {
                    ...
                    // remove from bottom stack and add to top of stack
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.d("vv","current thread : "+Thread.currentThread().getName());
...
//        super.onBackPressed();
        ...
        if(backStackCount > 1){
            ...
            // check if home scroll to top recyclerView
            String topFragmentTag = mFragmentsTags.get(backStackCount - 1);
    ...
    private void setFragmentVisibilities(String tagname){
        ...
        if(tagname.equals(getString(R.string.tag_fragment_home)))
            ...
            hideBottomNavigation();
       // loop every fragments in stack and show one top of stack only
        // do not forget this also happen when go from list to details fragment.
        ...
        // change icon when press back btn
